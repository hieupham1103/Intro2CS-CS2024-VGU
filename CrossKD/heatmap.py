...
def get_params():
    params = {
        'weight': 'TrainedModels/Dior/yolov8s.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'mps',
        'method': 'GradCAM',
...
if __name__ == '__main__':
    ...
    # https: // github.com / z1069614715 / objectdetection_script / blob / master / yolo - gradcam / yolov8_heatmap.py